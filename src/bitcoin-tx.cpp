...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s proletariancoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  proletariancoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded proletariancoin transaction") + "\n" +
              "  proletariancoin-tx [options] -create [commands]   " + _("Create hex-encoded proletariancoin transaction") + "\n" +
              "\n";
