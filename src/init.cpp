...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ernanbaldomero/proletariancoin>";
    const std::string URL_WEBSITE = "<https://proletariancoin.cf>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Proletariancoin version %s\n", FormatFullVersion());
}
