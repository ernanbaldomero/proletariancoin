...
#if defined(NDEBUG)
# error "Proletariancoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Proletariancoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PRC additional fees, %d delta bytes\n",
